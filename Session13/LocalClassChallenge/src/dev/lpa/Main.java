...
public class Main {
  ...
  public static void main(String[] args){
    ...
    Employee e4 = new Employee("Daisy", "Duck", "05/13/2013");
    Employee e5 = new Employee("Goofy", "Dog", "23/07/2020");

    List<Employee> Employees = new ArrayList<>(Arrays.asList(e1, e2,e3,e4,e5));

    printOrderList(Employees, "name");
    System.out.println();
    printOrderList(Employees, "year");


  }

  public static void printOrderList(List<Employee> employeesList, String sort){
    ...
    class MyEmployee {
      ...
      public String toString() {
        return " %s has been an employe for %d years". formatted(fullName, yearsWorked);
      }
    }
